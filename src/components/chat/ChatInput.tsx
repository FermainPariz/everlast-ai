...
const ChatInput = forwardRef<HTMLFormElement, ChatInputProps>(
  ({ input, isLoading, placeholder = 'Stelle eine Frage…', onChange, onSubmit }, ref) => {
    ...
    return (
      <form
        ref={ref}
        onSubmit={onSubmit}
        className="flex items-end gap-3 px-4 pt-3 pb-4"
        style={{
      ...
      >
        <textarea
          ...
          style={{
            ...
            border: focused ? '1px solid rgba(34,211,238,0.4)' : '1px solid var(--border)',
            boxShadow: focused ? '0 0 0 1px rgba(34,211,238,0.1), 0 0 20px rgba(34,211,238,0.05)' : 'none',
